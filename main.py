...
if opcao_correspondencia == "1":
    ...
    print("1. Correspondência ampla (Broad Match): A palavra-chave pode aparecer em qualquer ordem e pode incluir palavras relacionadas.")
    print("2. Correspondência ampla modificada (Modified Broad Match): A palavra-chave deve aparecer na pesquisa, mas as palavras relacionadas podem ser inseridas antes ou depois da palavra-chave.")
    print("3. Correspondência de frase (Phrase Match): A palavra-chave deve aparecer exatamente como digitada, mas outras palavras podem aparecer antes ou depois dela.")
    print("4. Correspondência exata (Exact Match): A palavra-chave deve aparecer exatamente como digitada, sem outras palavras.")
